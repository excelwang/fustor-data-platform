...
│  │  │  (sensord A)   │  │  (sensord B)   │  │  (No sensord)  │            │ │
...
├── fixtures/                   # 模块化测试组件 (Docker/sensord/Leadership)
...
- [integration-testing Skill](../../.sensord/skills/integration-testing/SKILL.md) - AI 助手集成测试指南
