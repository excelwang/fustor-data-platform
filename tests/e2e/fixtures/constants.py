...
# --- FS Thresholds ---
# HOT_FILE_THRESHOLD: MUST match datacastst docker config (hot_file_threshold).
# If reducing this, also update docker-compose.yml / datacastst config.
...
INGESTION_DELAY = 6.0    # datacastst scan + network + fustord process
