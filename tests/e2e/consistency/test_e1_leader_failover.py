...
class TestLeaderFailover:
    ...
    def test_follower_becomes_leader_after_crash(
        ...
        """
        场景:
          1. datacast A 是 Leadedatacastcast B 是 Follower
        ...
        try:
            ...
            # Restart datacast A container andatacastcast process for other tests
            docker_manager.start_container(CONTAINER_CLIENT_A)
            setup_datacasts["ensurdatacastcast_running"](
                CONTAINER_CLIENT_A, 
