"""
Test case to verify that the fustord_sdk correctly handles surrogate characters
"""
import pytest
import asyncio
from unittest.mock import AsyncMock, patch
from fustord_sdk.client import fustordClient, sanitize_surrogate_characters
...
async def test_push_events_with_surrogate_characters():
    ...
    client = fustordClient("http://test.com", "fake-api-key")
...
def test_contains_surrogate_characters_detection():
    ...
    from fustord_sdk.client import contains_surrogate_characters
