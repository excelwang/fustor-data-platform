...
# Mock DatacastPipe for testing methods without full init
class MockDatacastPipe(DatacastPipe):
    def __init__(self):
        self.id = "test-pipe"
...
async def test_check_task_liveness_zombie():
    # Setup
    with patch("datacast.stability.pipe.logger"):
        pipe = MockDatacastPipe()
