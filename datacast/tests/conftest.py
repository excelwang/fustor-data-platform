...
from datacast.domain.configs.pipe import PipeConfigService, DatacastPipeConfig
from datacast.domain.configs.source import SourceConfigService, SourceConfig
from datacast.domain.configs.sender import SenderConfigService, SenderConfig
...
from datacast_core.models.config import PasswdCredential, FieldMapping # Kept as they are used and not replaced by new imports
...
"sources": {
    "test-test": {
        "driver": "mysql",
        "uri": "localhost:3306",
        "credential": {"user": "datacast", "passwd": ""},
        "disabled": False,
    ...
    with open(config_dir / "datacast-config.yaml", 'w') as f:
