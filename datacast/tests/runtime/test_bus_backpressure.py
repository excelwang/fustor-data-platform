# datacast/tests/runtime/test_bus_backpressure.py
"""
U5: EventBus 背压策略 — Transient 事件在 Buffer 满时被丢弃。

被测代码: datacast/src/datacast/runtime/bus.py → MemoryEventBus.put(is_transient=True)
"""
import pytest
import asyncio
...
from datacast_core.exceptions import TransientSourceBufferFullError
