...
The Protocol Carrier layer is the **True Symmetry Point** of the Datacast ecosystem. It defines the binary/textual wire formats and state machines used to maintain the "Umbilical Cord" and the "Data Stream".

## [protocol] SCP_Datacast_Control_Protocol
...
## [protocol] SDP_Datacast_Data_Protocol
