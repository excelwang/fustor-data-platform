...
from datacast_core.models.config import FieldMapping
            ...
            async with self.lock:
                ...
                if is_transient:
                    raise TransientSourceBufferFullError(
                        ...
                        f"Consider doubling its size in the datacast config, specifically at the max_queue_size parameter in the source config."
                    )
