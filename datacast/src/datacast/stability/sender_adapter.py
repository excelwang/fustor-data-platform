# datacast/src/datacast/runtime/sender_handler_adapter.py
"""
Adapter to wrap a Sender transport as a SenderHandler for use in DatacastPipe.
...
class SenderHandlerAdapter(SenderHandler):
    ...
    - datacast_core.transport.Sender (transport/protocol layer)
    - datacast_core.pipe.sender.SenderHandler (pipe/handler layer)
