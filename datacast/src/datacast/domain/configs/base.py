# src/datacast/services/configs/base.py
import logging
from typing import Dict, Optional, TypeVar, Generic, Any

from datacast import get_app_config
...
from datacast_core.exceptions import ConfigError, NotFoundError, ConflictError
from datacast_sdk.interfaces import BaseConfigService # Import the interface
