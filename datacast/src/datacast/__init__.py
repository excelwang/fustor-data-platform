...
from datacast_core.models.config import AppConfig, PipeConfig, PipeConfigDict, SourceConfigDict, SenderConfigDict
...
STATE_FILE_NAME = 'datacast-state.json'
STATE_FILE_PATH = os.path.join(CONFIG_DIR, STATE_FILE_NAME)

from datacast_core.exceptions import ConfigError as ConfigurationError
...
def get_app_config() -> AppConfig:
    ...
    if _app_config_instance is None:
        ...
        # Convert DatacastPipeConfig to PipeConfig
