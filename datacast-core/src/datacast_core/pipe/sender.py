# packages/core/src/datacast_core/pipe/sender.py
"""
Sender Handler abstraction for datacast Pipes.

A Sender handler transmits events from datacast to fustord.
...
class SenderHandler(Handler):
    ...
    They are used on the datacast side.
