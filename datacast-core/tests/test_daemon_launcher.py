...
from datacast_core.common.daemon_launcher import main
...
def test_daemon_launcher_main_success(tmp_path):
    ...
    with patch.dict(sys.modules, {"mock_module": mock_module}):
        with patch("uvicorn.run") as mock_uvicorn:
            with patch("datacast_core.common.daemon_launcher.get_fustor_home_dir", return_value=str(tmp_path)):
                with patch("datacast_core.common.daemon_launcher.setup_logging"):
