...
from .pipe.manager_lifecycle import ManagerLifecycleMixin
from .pipe.manager_callbacks import ManagerCallbacksMixin
...
PipeManager = FustordPipeManager # Legacy alias
