...
from fustord.view_manager.manager import get_cached_view_manager
from fustord.api.consistency import consistency_router
...
class ManagerLifecycleMixin:
    ...
    async def _initialize_pipes_internal(self: "FustordPipeManager", config_list: Optional[List[str]] = None):
        ...
        """
        logger.info(f"FustordPipeManager: Initializing with config_list={config_list}")
            ...
            try:
                ...
                for v_id, v_cfg in resolved['views'].items():
                    ...
                    try:
                        ...
                        from fustord.runtime.view_handler_adapter import create_view_handler_from_manager
