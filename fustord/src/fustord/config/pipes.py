# fustord/src/fustord/config/pipes.py
"""
Unified fustord Pipe configuration loader.
...
class PipesConfigLoader:
    """
    Loads fustord pipe configurations from $FUSTOR_HOME/pipes/ directory.
    """
    ...
    def scan(self) -> Dict[str, fustordPipeConfig]:
        ...
        for yaml_file in self.dir.glob("*.yaml"):
            ...
            try:
                ...
                logger.debug(f"Skipping non-fustord config {yaml_file}: {e}")
