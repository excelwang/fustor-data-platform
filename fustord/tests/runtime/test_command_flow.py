...
async def test_fustord_command_queue_flow():
    ...
    # The driver does `from fustord.core.session_manager import session_manager` inside the method.
    # So we should patch that import or verify using the global instance.
    
    from fustord.core.session_manager import session_manager as global_sm
