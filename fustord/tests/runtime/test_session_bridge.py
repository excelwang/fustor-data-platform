...
class TestPipeSessionBridgeInit:
    ...
    async def test_close_session(self, session_bridge, mock_pipe, mock_session_manager):
        ...
        with patch("fustord.view_state_manager.view_state_manager.unlock_for_session", AsyncMock()), \
             patch("fustord.view_state_manager.view_state_manager.release_leader", AsyncMock()):
