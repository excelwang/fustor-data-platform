...
if TYPE_CHECKING:
    ...
    from sensord.services.instances.bus import EventBusInstanceRuntime
    from fustor_core.models.states import PipeInstanceDTO
...
class SensordPipe(FustorPipe, PipeLifecycleMixin, PipeLeaderMixin):
    ...
    def __init__(
        ...
        self.task_id: Optional[str] = None  # Resolved at session creation (sensord_id:pipe_id)
    ...
    def _load_mgmt_processor(self) -> Optional[Any]:
        ...
        try:
            # Use sensord.command_processors entry point group
    ...
    def _build_sensord_status(self) -> Dict[str, Any]:
        """Build sensord status dict for heartbeat reporting to management plane."""
        sensord_id = None
