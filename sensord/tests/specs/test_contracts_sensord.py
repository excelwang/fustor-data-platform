...
class TestSensordContracts(unittest.TestCase):
    """
    Contract verification tests for Sensord L1 Contracts.
    ...
    def test_stability_contracts(self):
        """
        Sensord MUST implement exponential backoff and never stop retrying.
        """
    ...
    def test_data_routing_contracts(self):
        ...
        assert "sensor_id" in processed
        assert processed["temperature"] == 25.5
        assert processed["sensor_id"] == 101
    ...
    def test_autonomy_contracts(self):
        """
        Sensord MUST have intrinsic drive (initialize without network).
        """
        ...
        pipe = SensordPipe("test", {}, source, sender)
    ...
    def test_lifecycle_contracts(self):
        ...
        dto = pipe.get_dto()
        from sensord_core.models.states import PipeState as TaskState
        assert dto.state & TaskState.RUNNING_CONF_OUTDATE

    @verify_spec("CONTRACTS.CONCURRENCY")
    def test_concurrency_contracts(self):
        """
        Sensord MUST use non-blocking I/O and sequential state mutations.
        """
    ...
    def test_addressing_contracts(self):
        """
        Sensord MUST treat payloads as opaque and follow addressing primitives.
        """
        ...
        # but we can check if any business logic is leaked into SensordPipe's addressing.
        source = MagicMock()
        sender = MagicMock()
        pipe = SensordPipe("test", {}, source, sender)
    ...
    def test_testing_contracts(self):
        ...
        # but we verify SensordPipe passes them from config
    ...
    def test_layer_independence_contracts(self):
        ...
        stability_file = "/home/huajin/fustor-1/sensord/src/sensord/stability/pipe.py"
